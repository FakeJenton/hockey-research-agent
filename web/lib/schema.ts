...
- No playoff data, no shot-location/xG data, no line combinations, no player-level game logs.
- Game-grain data (fct_team_games, rolling) is 2025-26 only.
- Ice time by strength exists ONLY as the season-level columns listed above; short-handed per-60 production is not computable (no sh per-60 column) and per-60 splits do not exist at game grain.
